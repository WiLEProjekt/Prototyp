...
_SUBVERSION_REVISION = '$Revision: 25 $'
_SUBVERSION_DATE = '$Date: 2009-06-20 21:35:51 +0100 (Sat, 20 Jun 2009) $'
...
def DoWrite(rgm, args):
  f = open(str(datetime.datetime.now()) + "_gps.txt", "w")
  filters = []
  arglen = len(args)
  try:
    while True:
...
def DoHelp():
  ...
  print '    write [<filter>]                Continuously read+dump data from device and write to a file'

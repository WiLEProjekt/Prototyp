...
enum {
	...
	TCA_NETEM_CORRUPT,
	TCA_NETEM_LOSS,
	TCA_NETEM_SEED,		/* mark that there is one or more seed for random numbers */
	TCA_NETEM_RATE,
	TCA_NETEM_ECN,
	TCA_NETEM_RATE64,
	TCA_NETEM_PAD,
...
struct tc_netem_rnd_number_generator {
	...
	__u64	corrupt_seed; /* seed for random number of corruption */
	__u64	reorder_seed; /* seed for random number of reordering */
	__u64	duplication_seed; /* seed for random number of duplication */
};
...
struct tc_netem_losstrace {
	...
	__u32 shmid; /* contains the shm id */
};

...
public:
     ...
     */
    MarkovModel(long numPackets, float p13, float p31, float p32, float p23, float p14, float p41)
            : BasePacketlossModel(numPackets), p13(p13), p14(p14), p23(p23), p31(p31), p32(p32), p41(p41) {}
    /**
     *
     * Constructor
